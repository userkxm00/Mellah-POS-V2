...
export function MaintenancePage({ onBack }: { onBack?: () => void }): React.JSX.Element {
  ...
  const [tasks, setTasks] = useState<MaintenanceTask[]>([
    {
      id: 'integrity',
      label: 'فحص سلامة قاعدة البيانات',
      labelFr: 'Vérification d\'intégrité de la base',
      description: 'يتحقق من عدم وجود تلف أو بيانات معطوبة في قاعدة البيانات المحلية.',
    ...
    {
      id: 'vacuum',
      label: 'ضغط وتحسين قاعدة البيانات',
      labelFr: 'Compacter et optimiser la base',
      description: 'يُعيد تنظيم ملف القاعدة ويحرر المساحة غير المستخدمة لتسريع الأداء.',
    ...
    {
      id: 'cache',
      label: 'تنظيف الملفات المؤقتة والكاش',
      labelFr: 'Nettoyer les fichiers temporaires et le cache',
      description: 'يحذف ملفات الكاش المؤقتة التي قد تسبب بطء أو مشاكل في العرض.',
