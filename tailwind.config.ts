...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        card: '0 1px 3px rgba(0,0,0,0.04), 0 4px 12px rgba(0,0,0,0.04), 0 8px 24px rgba(0,0,0,0.03)',
        elevated: '0 10px 20px rgba(0,0,0,0.04), 0 20px 48px rgba(0,0,0,0.08), 0 0 0 1px rgba(0,0,0,0.05)',
        glow: '0 12px 32px -4px rgba(10, 132, 255, 0.35), 0 4px 16px rgba(0,0,0,0.08)',
        ambient:
        ...
        'ambient-md':
          '0 2px 6px rgba(0,0,0,0.05), 0 8px 24px rgba(0,0,0,0.06)',
        ...
        'layered-deep':
          '0 12px 32px rgba(0,0,0,0.12), 0 24px 64px rgba(0,0,0,0.16)',
        'hero-glow':
